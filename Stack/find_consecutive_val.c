/*
Find and display pairs of consecutive values in a stack
If the amount of elements is an odd number, ignore the top element
*/
...
int main(void) {
	...
	printf("Finding consecutive values...\n");
	consecutive(S);
